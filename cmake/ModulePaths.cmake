...
set(RISMLIB_CUDA_SP_MOD_DIR "${MODULE_BASE_DIR}/rism/lib/cuda_sp")
set(RISMLIB_CUDA_DP_MOD_DIR "${MODULE_BASE_DIR}/rism/lib/cuda_dp")
...
set(RISMLIB_SFF_INTERFACE_CUDA_SP_DIR "${MODULE_BASE_DIR}/rism/sff_interface/cuda_sp")
set(RISMLIB_SFF_INTERFACE_CUDA_DP_DIR "${MODULE_BASE_DIR}/rism/sff_interface/cuda_dp")
...
file(MAKE_DIRECTORY ${AMBER_COMMON_MOD_DIR} ${SQMLIB_MOD_DIR} ${SQMEXE_MOD_DIR} ${LIBPBSA_MOD_DIR} ${LIBPBSA_SANDER_MOD_DIR}
	${PBSAEXE_MOD_DIR} ${SANDER_COMMON_MOD_DIR} ${SEBOMD_MOD_DIR} ${RISMLIB_MOD_DIR} ${RISMLIB_CUDA_SP_MOD_DIR} ${RISMLIB_CUDA_DP_MOD_DIR} ${RISM1D_MOD_DIR} ${RISMTHERMO_MOD_DIR}
	...
	${RISMLIB_SFF_INTERFACE_MPI_DIR} ${RISMLIB_SFF_INTERFACE_CUDA_SP_DIR} ${RISMLIB_SFF_INTERFACE_CUDA_DP_DIR} ${SEBOMD_MPI_MOD_DIR} ${QUICK_MPI_MOD_DIR} ${QUICK_CUDA_MOD_DIR} ${QUICK_CUDA_MPI_MOD_DIR}
