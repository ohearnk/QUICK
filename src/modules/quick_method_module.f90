...
module quick_method_module
    ...
    contains
        ...
        subroutine broadcast_quick_method(self, ierr)
            ...
            call MPI_BCAST(self%HF,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%DFT,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%MP2,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%B3LYP,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%BLYP,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%BPW91,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%MPW91LYP,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%MPW91PW91,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%PBSOL,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%UNRST,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%debug,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%nodirect,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%readDMX,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%diisSCF,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%prtGap,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%opt,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%grad,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%analGrad,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%analHess,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%esp_charge,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%espgrid_spacing,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%vdw_radii,5,mpi_character,0,quick_comm,mpierror)
            call MPI_BCAST(self%esp_grid,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%efield_grid,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%efg_grid,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%diisOpt,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%core,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%annil,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%freq,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%SEDFT,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%Zmat,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%dipole,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%ecp,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%custECP,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%printEnergy,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%hasF,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%calcDens,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%calcDensLap,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%gridspacing,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%lapGridSpacing,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%readden,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%read_coord,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%writeden,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%writexyz,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%extCharges,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%ext_grid,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%extgrid_angstrom,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%PDB,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%SAD,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%FMM,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%DIVCON,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%MFCC,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%ifragbasis,1,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%iSG,1,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%iscf,1,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%iscf_sad,1,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%iopt,1,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%maxdiisscf,1,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%ncyc,1,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%integralCutoff,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%leastIntegralCutoff,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%maxIntegralCutoff,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%primLimit,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%gradCutoff,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%DMCutoff,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%XCCutoff,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%pmaxrms,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%basisCutoff,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%stepMax,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%geoMaxCrt,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%gRMSCrt,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%gradMaxCrt,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%gNormCrt,1,mpi_double_precision,0,quick_comm,mpierror)

            !mpi variables for libxc implementation
            call MPI_BCAST(self%uselibxc,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%nof_functionals,1,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%functional_id,FUNCTIONAL_ID_SIZE,mpi_integer,0,quick_comm,mpierror)
            call MPI_BCAST(self%x_hybrid_coeff,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%xc_polarization,1,mpi_double_precision,0,quick_comm,mpierror)
            call MPI_BCAST(self%usedlfind,1,mpi_logical,0,quick_comm,mpierror)
            call MPI_BCAST(self%allow_bad_scf,1,mpi_logical,0,quick_comm,mpierror)
