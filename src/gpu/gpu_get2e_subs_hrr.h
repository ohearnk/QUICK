...
__device__ static inline int lefthrr(QUICKDouble RAx, QUICKDouble RAy, QUICKDouble RAz,
...
__device__ static inline int lefthrr23(QUICKDouble RAx, QUICKDouble RAy, QUICKDouble RAz,
        ...
        int KLMNAx, int KLMNAy, int KLMNAz,
        int KLMNBx, int KLMNBy, int KLMNBz,
        QUICKDouble * const coefAngularL, unsigned char * const angularL)
{
    int numAngularL;
...
__device__ static inline int lefthrr_sp(QUICKDouble RAx, QUICKDouble RAy, QUICKDouble RAz,
        QUICKDouble RBx, QUICKDouble RBy, QUICKDouble RBz,
        int KLMNAx, int KLMNAy, int KLMNAz,
        int KLMNBx, int KLMNBy, int KLMNBz,
        int IJTYPE, QUICKDouble * const coefAngularL, unsigned char * const angularL)
...
__device__ static inline QUICKDouble hrrwhole_sp(int I, int J, int K, int L,
            ...
            if (angularL[i] <= STOREDIM && angularR[j] <= STOREDIM) {
                Y += coefAngularL[i] * coefAngularR[j]
                    * LOCSTORE(&devSim.store[blockIdx.x * blockDim.x + threadIdx.x],
                            angularL[i] - 1, angularR[j] - 1, STOREDIM, STOREDIM);
...
__device__ static inline int lefthrr_spd(QUICKDouble RAx, QUICKDouble RAy, QUICKDouble RAz,
        QUICKDouble RBx, QUICKDouble RBy, QUICKDouble RBz,
        int KLMNAx, int KLMNAy, int KLMNAz,
        int KLMNBx, int KLMNBy, int KLMNBz,
        int IJTYPE, QUICKDouble * const coefAngularL, unsigned char * const angularL)
...
__device__ static inline QUICKDouble hrrwhole(int I, int J, int K, int L,
        int III, int JJJ, int KKK, int LLL,
        QUICKDouble RAx, QUICKDouble RAy, QUICKDouble RAz,
        QUICKDouble RBx, QUICKDouble RBy, QUICKDouble RBz,
        QUICKDouble RCx, QUICKDouble RCy, QUICKDouble RCz,
